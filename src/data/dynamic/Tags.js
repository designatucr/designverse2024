...
export const COLORS = {
  ...
  uiux: mappings["red"],
  tier1: mappings["red"],
  tier2: mappings["yellow"],
  tier3: mappings["teal"],
  tier4: mappings["grayblue"],
  tier5: mappings["green"],
  other: mappings["teal"],
  view: mappings["gray"],
