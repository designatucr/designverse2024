...
export const FIELDS = {
  description: {
    ...
    width: 12,
    texts: [
      "Welcome to DesignVerse. Thank you for being on the organizing team, we appreciate your efforts to help support DesignVerse. DesignVerse is a DESCRIPTION hackathon spanning 24 hours on May 11, 2024.",
