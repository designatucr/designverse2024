...
export const FIELDS = {
  description: {
    ...
    width: 12,
    texts: [
      "Welcome to DesignVerse. Thank you for considering to become a judge, we appreciate your efforts to help support DesignVerse. DesignVerse is UCR’s first ever UI/UX Design-a-Thon! On May 11, 2024 over the course of 24 hours, you’ll be able to challenge your problem solving skills, create innovative prototypes, and engage with a panel of industry experts!",
