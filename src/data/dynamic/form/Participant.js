...
export const FIELDS = {
  description: {
    ...
    width: 12,
    texts: [
      "Welcome to DesignVerse. Thank you for considering to become a participant, we appreciate your enthusiasm to join DesignVerse. DesignVerse is a DESCRIPTION hackathon spanning 24 hours on May 11, 2024.",
