...
const Form = ({
  ...
  return (
    <div className="w-full h-full overflow-y-scroll flex flex-col items-center bg-design-orange font-workSans font-semibold">
      ...
      <div className="w-10/12 md:w-1/2 xl:w-1/3 my-4">
        <p className="text-xl bg-design-green-800 font-semibold px-4 py-2 rounded-t-xl m-0">
          {header}
        </p>
