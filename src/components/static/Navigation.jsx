    ...
    <div className="w-full ml-3 py-2">
      <div className="fixed group z-50">
        <button
          ...
          className={`${
            isDropdownOpen
              ...
              : "opacity-100 bg-design-green-300 duration-300"
          }bg-design-green-300 rounded-xl w-1/4 pl-4 py-2.5 drop-shadow-xl`}
        >
        ...
        <div
          ...
          } bg-design-green-300 p-2 ml-0 -mt-10 grid grid-col rounded-xl drop-shadow-lg `}
        >
